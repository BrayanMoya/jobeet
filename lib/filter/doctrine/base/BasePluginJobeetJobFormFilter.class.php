...
/**
 * PluginJobeetJob filter form base class.
 *
 * @package    jobeet
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BasePluginJobeetJobFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('plugin_jobeet_job_filters[%s]');
