...
/**
 * PluginJobeetAffiliate filter form base class.
 *
 * @package    jobeet
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BasePluginJobeetAffiliateFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('plugin_jobeet_affiliate_filters[%s]');
