...
/**
 * PluginJobeetCategory filter form base class.
 *
 * @package    jobeet
 * @subpackage filter
 ...
 * @version    SVN: $Id$
 */
abstract class BasePluginJobeetCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('plugin_jobeet_category_filters[%s]');
