...
/**
 * PluginJobeetJob form base class.
 *
 * @method PluginJobeetJob getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BasePluginJobeetJobForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'PluginJobeetJob', 'column' => array('token')))
    );

    $this->widgetSchema->setNameFormat('plugin_jobeet_job[%s]');
