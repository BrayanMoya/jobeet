...
/**
 * PluginJobeetCategory form base class.
 *
 * @method PluginJobeetCategory getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 * @version    SVN: $Id$
 */
abstract class BasePluginJobeetCategoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('plugin_jobeet_category[%s]');
