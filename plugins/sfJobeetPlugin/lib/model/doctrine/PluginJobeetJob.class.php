 ...
 */
class PluginJobeetJob extends BaseJobeetJob
{
    ...
    {
        return array(
            'sfJobeetCategory'     => $this->getJobeetCategory()->getName(),
            'type'         => $this->getType(),
...
//
//        // store sfJobeetJob primary key URL to identify it in the search results
//        $doc->addField(Zend_Search_Lucene_Field::UnIndexed('pk', $this->getId()));
//
//        // index sfJobeetJob fields
//        $doc->addField(Zend_Search_Lucene_Field::UnStored('position', $this->getPosition(), 'utf-8'));
//        $doc->addField(Zend_Search_Lucene_Field::UnStored('company', $this->getCompany(), 'utf-8'));
//        $doc->addField(Zend_Search_Lucene_Field::UnStored('location', $this->getLocation(), 'utf-8'));
//        $doc->addField(Zend_Search_Lucene_Field::UnStored('description', $this->getDescription(), 'utf-8'));
//
//        // add sfJobeetJob to the index
