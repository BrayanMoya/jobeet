...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="<?php echo url_for('sfJobeetCategory/show?id='.$jobeet_category->getId()) ?>"><?php echo $jobeet_category->getId() ?></a></td>
  ...
  <a href="<?php echo url_for('sfJobeetCategory/new') ?>">New</a>
