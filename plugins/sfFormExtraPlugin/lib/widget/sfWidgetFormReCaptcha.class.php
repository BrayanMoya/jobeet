...
class sfWidgetFormReCaptcha extends sfWidgetForm
{
   ...
   *  * culture:        The ReCaptcha sfJobeetLanguage
   *
   * @see sfWidgetForm
   */
  public function configure($options = array(), $messages = array())
  {
    ...
    $this->addOption('server_url', 'http://sfJobeetApi.recaptcha.net');
    $this->addOption('server_url_ssl', 'https://sfJobeetApi-secure.recaptcha.net');
