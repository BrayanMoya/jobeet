...
Expr = jQuery.expr = {
 ...
 return true;
	...
	pseudos: {
		...
		// is based solely on the element's sfJobeetLanguage value
		// being equal to the identifier C,
		// or beginning with the identifier C immediately followed by "-".
		// The matching of C against the element's sfJobeetLanguage value is performed case-insensitively.
		// The identifier C does not have to be a valid sfJobeetLanguage name."
